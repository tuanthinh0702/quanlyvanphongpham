...
namespace Musicviet.Class
{
    public class BK
    {
        ...
        //public static string baokim_url = "http://sandbox.baokim.vn/payment/customize_payment/order";

        ////Mã merchant site
        //public static string merchant_id = "701"; //"95";	//Thay bằng mã merchant site bạn đã đăng ký trên BaoKim.vn

        ////Mật khẩu bảo mật
        //public static string secure_pass = "120836b408437cf7"; //"f4c43894a855480e";	//Thay bằng mật khẩu giao tiếp giữa website của bạn với BaoKim.vn

        //public static string BUSINESS = "dao.trinh2009@gmail.com"; //"tranhieu86@gmail.com";



        ////URL checkout của BaoKim.vn
        public static string baokim_url = "https://www.baokim.vn/payment/customize_payment/order"; //"http://sandbox.baokim.vn/payment/customize_payment/order";

        //Mã merchant site
        public static string merchant_id = ""; //"95";	//Thay bằng mã merchant site bạn đã đăng ký trên BaoKim.vn

        //Mật khẩu bảo mật
        public static string secure_pass = ""; //"f4c43894a855480e";	//Thay bằng mật khẩu giao tiếp giữa website của bạn với BaoKim.vn

        public static string BUSINESS = ""; //"tranhieu86@gmail.com";



        public static string SUCCESS_URL = Config.WebsiteAppPath + "finish.aspx";
        public static string ERROR_URL = Config.WebsiteAppPath + "ssl/Member.htm?module=OrderDetail&id={0}";
        public static string DETAIL_URL = Config.WebsiteAppPath + "ssl/Member.htm?module=OrderDetail&id={0}";
        public static string SHIPPING_FEE = "0";
        public static string TAX_FEE = "0";
         ...
         * @return url cần tạo
         */
        public static String createRequestUrl(String order_id, String total_amount, String order_description)
        {
            ...
            order_params.Add("order_description", "Thanh toan chi phi mua ma the tai The365.vn");
            order_params.Add("url_success", SUCCESS_URL);
            order_params.Add("url_cancel", string.Format(ERROR_URL, order_id));
            order_params.Add("url_detail", string.Format(DETAIL_URL, order_id));
         ...
         */
        public static Boolean verifyResponseUrl(NameValueCollection get_params)
        {
