...
{
    public partial class NewsMgr : System.Web.UI.UserControl
    {
        ...
        {
            DataView dv = CategoryManager.SelectAllCateByStatus(0).DefaultView; //0 la tin tuc
        ...
        private void BindData()
        {
            try
            {
                DataTable dtb = NewsManager.SelectAllNews();
                if (dtb != null)
                {
        ...
        protected void btnApp_Click(object sender, EventArgs e)
        {
            ...
            BindData();
            if (Approved) this.lblError.Text = "Đã duyệt bài viết.";
            else this.lblError.Text = "Không có bài viết nào được duyệt.";
        }
