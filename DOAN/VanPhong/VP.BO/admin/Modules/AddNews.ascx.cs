...
namespace Musicviet.Administrators.Modules
{
    public partial class AddNews : System.Web.UI.UserControl
    {
        ...
        {
            DataView dv = CategoryManager.SelectAllCateByStatus(0).DefaultView;
           // dv.Sort = "CategoryName ASC";
            ...
            ListItem item = new ListItem("[Chọn chuyên mục tin]", "0");
        ...
        private bool CheckValid()
        {
            ...
            {
                this.lblError.Text = "Hãy nhập chi tiết bài viết";
                return false;
            }
