<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddColor.ascx.cs" Inherits="Musicviet.Administrators.Modules.AddColor" %>
        ...
        <tr valign="top">
            <td>
                <asp:UpdatePanel ID="udpAtributeList" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <asp:Panel ID="pnAtributeList" runat="server" GroupingText="Danh sách mầu sản phẩm" Width="450px" ScrollBars="Auto">
                            <asp:datagrid id="dg" 
                                Width="100%"
                                runat="server" 
                                CellPadding="2"
                                ...
                                <Columns>
			                       ...
			                       <asp:BoundColumn DataField="Colorname" HeaderText="Tên mầu sản phẩm"></asp:BoundColumn> 	
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server"
                                                CommandName="Edit" Text="Edit" 
                                                CommandArgument='<%# Eval("ColorID") %>'></asp:LinkButton>
                                        </ItemTemplate>                      
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>                    
                                        <ItemTemplate>
            ...
            <td>
                <asp:UpdatePanel ID="udpAtributeDetail" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="EditPanel" runat="server" Enabled="false" GroupingText="Thêm mới/cập nhật mầu sản phẩm">
                            <table cellpadding="3" cellspacing="0">                
                               <tr>
                                    <td>Tên mầu sản phẩm:</td>
                                    <td>
