<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddMade.ascx.cs" Inherits="Musicviet.Administrators.Modules.AddMade" %>
        ...
        <tr valign="top">
            <td>
                <asp:UpdatePanel ID="udpAtributeList" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <asp:Panel ID="pnAtributeList" runat="server" GroupingText="Danh sách xuất sứ" Width="450px" ScrollBars="Auto">
                            <asp:datagrid id="dg" 
                                Width="100%"
                                runat="server" 
                                CellPadding="2"
                                ...
                                <Columns>
			                       ...
			                       <asp:BoundColumn DataField="MadeName" HeaderText="Tên xuất sứ"></asp:BoundColumn> 	
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server"
                                                CommandName="Edit" Text="Edit" 
                                                CommandArgument='<%# Eval("MadeID") %>'></asp:LinkButton>
                                        </ItemTemplate>                      
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>                    
                                        <ItemTemplate>
            ...
            <td>
                <asp:UpdatePanel ID="udpAtributeDetail" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="EditPanel" runat="server" Enabled="false" GroupingText="Thêm mới/cập nhật xuất sứ">
