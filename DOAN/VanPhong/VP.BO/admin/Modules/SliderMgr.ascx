<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SliderMgr.ascx.cs" Inherits="Musicviet.Administrators.Modules.SliderMgr" %>
                                ...
                                <asp:GridView runat="server" ID="grData" GridLines="None" AutoGenerateColumns="False"
                                   ...
                                   PageSize='10'>
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                           <ItemTemplate>
                                               <a href="Home.aspx?module=Slider&id=<%#Eval("SliderID") %>" title="Chỉnh sửa sản phẩm"><img src="Images/edit.gif" /></a> |  <input type="checkbox" id="cbxDel" runat="server" value='<%# Eval("SliderID") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                               </Columns>
