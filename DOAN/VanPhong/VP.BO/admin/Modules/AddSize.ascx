<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddSize.ascx.cs" Inherits="Musicviet.Administrators.Modules.AddSize" %>
        ...
        <tr valign="top">
            <td>
                <asp:UpdatePanel ID="udpAtributeList" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <asp:Panel ID="pnAtributeList" runat="server" GroupingText="Danh sách kích thức(cỡ)" Width="450px" ScrollBars="Auto">
                            <asp:datagrid id="dg" 
                                Width="100%"
                                runat="server" 
                                CellPadding="2"
                                ...
                                <Columns>
			                       ...
			                       <asp:BoundColumn DataField="Sizename" HeaderText="Tên kích thức(cỡ)"></asp:BoundColumn> 	
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server"
                                                CommandName="Edit" Text="Edit" 
                                                CommandArgument='<%# Eval("SizeID") %>'></asp:LinkButton>
                                        </ItemTemplate>                      
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn>                    
                                        <ItemTemplate>
            ...
            <td>
                <asp:UpdatePanel ID="udpAtributeDetail" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="EditPanel" runat="server" Enabled="false" GroupingText="Thêm mới/cập nhật kích thức(cỡ)">
                            <table cellpadding="3" cellspacing="0">                
                               <tr>
                                    <td>Tên kích thức(cỡ):</td>
                                    <td>
