...
{
    public partial class CateOther : System.Web.UI.UserControl
    {
        protected int CatID
        {
            get
        ...
        {
            DataTable dtb = CategoryManager.SelectAllCateByStatus(2);
        ...
        private void InitializeCategoryTreeView()
        {
            ...
            DataTable dtb = CategoryManager.SelectAllByTypeAndParent(0,2);
