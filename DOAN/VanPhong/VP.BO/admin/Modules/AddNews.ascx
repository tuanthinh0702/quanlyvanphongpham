<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddNews.ascx.cs" Inherits="Musicviet.Administrators.Modules.AddNews" %>
...
<div class="container" id="actualbody">
    ...
    <asp:Panel ID="pnDetail" runat="server" GroupingText="Thông tin chi tiết bài viết">
