...
{
    public partial class AddNewsCustomer : System.Web.UI.UserControl
    {
        ...
        {
            DataView dv = CategoryManager.SelectAllCateByStatus(3).DefaultView;
           // dv.Sort = "CategoryName ASC";
            ...
            ListItem item = new ListItem("[Chọn chuyên CSKH]", "0");
        ...
        private bool CheckValid()
        {
            ...
            {
                this.lblError.Text = "Hãy nhập chi tiết CSKH";
                return false;
            }
