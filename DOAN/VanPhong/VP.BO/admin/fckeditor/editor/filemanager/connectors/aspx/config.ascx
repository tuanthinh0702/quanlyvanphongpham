...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        TypeConfig["Flash"].QuickUploadAbsolutePath     = (UserFilesAbsolutePath == "" ? "" : "%UserFilesPath%flash/");
        ...
        TypeConfig["Media"].QuickUploadAbsolutePath     = (UserFilesAbsolutePath == "" ? "" : "%UserFilesPath%media/");
	}
