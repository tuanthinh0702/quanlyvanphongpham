    ...
    <div class="main-container">
        <div id="dProductInfor" class="product-information clearfix">
            <asp:Repeater runat="server" ID="rptproductdetail" 
                ...
                <ItemTemplate>
                     <div class="product-image" id="rptimgmore0">
                     ...
                     <div class="pro-block pro-price">
                        ...
                        <%-- giỏ hang--%>
                         <div class="nutdathang"><a href="#" onclick="$.add2cart( 'rptimgmore0', 'cart-id','<%#Eval("ProductID") %>' )"><input type="button"  value="Mua Hàng" /></a></div> 
                        <%-- end gio hang--%>
