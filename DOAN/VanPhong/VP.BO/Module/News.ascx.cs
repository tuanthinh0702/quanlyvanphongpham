...
{
    public partial class News : WebControlBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
               lblCatename.Text = GetNewsName();
            }
            GetAllNews();
        }
        ...
        public  string  GetNewsName()
        {
            ...
            {
                CategoryInfo info = CategoryManager.Select(CatID);
        ...
        public void GetAllNews()
        {
            if (Request["CategoryID"] != null)
            {
                ...
                if (dCat.Rows.Count > 0)
                {
                    ...
                    clpNews.BindToControl = rptBynews;
                    rptBynews.DataSource = clpNews.DataSourcePaged;
                    rptBynews.DataBind();
                }
                else
                {
