...
{
    public partial class NewsDetail : WebControlBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Common.PageTitle.PageTitles = gettitle(int.Parse(Request["NewsID"]));
                Common.PageTitle.PageDescription = "<meta name='Description'   content='" + getDes(int.Parse(Request["NewsID"])) + "'" + "/>";
                Common.PageTitle.PageKeywords = "<meta name='Keywords'   content='" + getkey(int.Parse(Request["NewsID"])) + "'" + "/>";
                GetAllNewsDetail();
                Getsever();
                GetTitle();
            }
