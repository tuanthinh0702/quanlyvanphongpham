<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Product.ascx.cs" Inherits="Musicviet.Module.Product" %>
    ...
    <div class="main-container clearfix">
        <div class="side-bar">
            ...
            <div class="module-promotion">
                <img src="/img/panel_small2.jpg" width="228" height="205" alt="Promotion" />
            </div>
        </div>
        ...
        <div id="productContent" class="primary-content">
            ...
            <div class="pgn-tools  clearfix">
                 <div class="tools-paging">
                  <span style="font-weight: bold;"><asp:Label runat="server" ID="lblNamecate"></asp:Label></span>
                 </div>
