...
$(function() {
    ...
    if (titleBG != null) {
        $("#pattern").css("backgroundImage", "url(images/background/" + titleBG + ")");
    }

    if (bodyBG != null) {
        $("body").css("backgroundImage", "url(images/background/" + bodyBG + ")");
    }
...
function changeTitlePattern() {
    ...
    //alert("url(images/background/"+imgfile+")");
    $("#pattern").css("backgroundImage", "url(images/background/" + imgfile + ")");
...
function changeBGPattern() {
    ...
    //alert("url(images/background/"+imgfile+")");
    $("body").css("backgroundImage", "url(images/background/" + imgfile + ")");
...
function changePreset() {
    ...
    $("#pattern").css("backgroundImage", "url(images/background/" + presets[3] + ")");
    createCookie('titleBG', presets[3]);
    $("body").css("backgroundImage", "url(images/background/" + presets[4] + ")");
