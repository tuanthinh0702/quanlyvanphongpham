<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddNewsOther.ascx.cs" Inherits="Musicviet.Administrators.Modules.AddNewsOther" %>
...
<div class="container" id="actualbody">
    ...
    <asp:Panel ID="pnDetail" runat="server" GroupingText="Thông tin chi tiết dịch vụ">
