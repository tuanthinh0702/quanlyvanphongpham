<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CateOtherMgrList.ascx.cs" Inherits="Musicviet.Administrators.Modules.CateOtherMgrList" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left">
                            ...
                            <ItemTemplate>
                                ...
                                <a href="home.aspx?module=AddNewsOther&id=<%#Eval("NewsID") %>">
                                    <%# Eval("Title")%></a>
                            </ItemTemplate>
