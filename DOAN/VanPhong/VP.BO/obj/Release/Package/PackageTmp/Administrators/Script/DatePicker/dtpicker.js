...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = "/Script/DatePicker/"			// directory for images ... e.g. var imgDir="/img/"

	var gotoString = "Tới tháng hiện tại"
	var todayString = "Hôm nay là"
	var weekString = "Wk"
	var scrollLeftMessage = "Click vào đây để quay trở về tháng trước. Giữ chuột để tự động quay về."
	var scrollRightMessage = "Click vào đây để qua tháng sau. Giữ chuột để tự động chuyển."
   ...
   function WeekNbr(n) {
	...
	function popUpCalendar(id, id2, format) {
		var	leftpos=0
		var	toppos=0
