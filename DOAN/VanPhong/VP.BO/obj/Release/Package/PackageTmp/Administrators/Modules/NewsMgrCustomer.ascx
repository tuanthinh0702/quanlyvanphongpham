<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewsMgrCustomer.ascx.cs" Inherits="Musicviet.Administrators.Modules.NewsMgrCustomer" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left">
                            ...
                            <ItemTemplate>
                                ...
                                <a href="home.aspx?module=AddNewsCustomer&id=<%#Eval("NewsID") %>">
                                    <%# Eval("Title")%></a>
                            </ItemTemplate>
